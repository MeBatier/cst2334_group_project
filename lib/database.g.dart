    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Expense` (`id` INTEGER, `name` TEXT NOT NULL, `category` TEXT NOT NULL, `amount` REAL NOT NULL, `date` TEXT NOT NULL, `paymentMethod` TEXT NOT NULL, PRIMARY KEY (`id`))');
